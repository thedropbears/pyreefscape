...
class AlgaeManipulatorComponent:
    ...
    def __init__(self) -> None:
        ...
        self.flywheel_speed_error = 0.1

    def spin_flywheels(self) -> None:
        self.desired_flywheel_speed = self.flywheel_shoot_speed

    def flywheels_up_to_speed(self) -> bool:
            if abs(self.flywheel_1.get() - self.desired_flywheel_speed) <= self.flywheel_speed_error and abs(self.flywheel_2.get() - self.desired_flywheel_speed) <= self.flywheel_speed_error:
                return True
