...
class BallisticsComponent:
    ...
    x_max_offset_range = 3.0  # in meters
    ...
    # TODO add code that accounts for ball size
    FLYWHEEL_SPEED_LOOKUP_MAX_BALL = (37, 45)
    FLYWHEEL_SPEED_LOOKUP_MED_BALL = ()
    FLYWHEEL_SPEED_LOOKUP_MIN_BALL = (45, 95)
        ...
        return BallisticsSolution(
            float(
                numpy.interp(
                    ...
                    self.FLYWHEEL_SPEED_LOOKUP_MAX_BALL,
                )
            ),
            float(
                numpy.interp(
