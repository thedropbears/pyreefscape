...
class VisualLocalizer(HasPerLoopCache):
    ...
    def __init__(
        ...
        # Offset of encoder when facing forwards (the desired zero)
        # To find this value, manually point the camera forwards and record the encoder value and convert to Rotation2d
